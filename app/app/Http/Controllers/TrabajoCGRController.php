...
class TrabajoCGRController extends Controller
{
    ...
    public function tablaResultado(Request $request){
        $consulta= DB::connection('mysql2')->table('informes_areacgrs')
            ...
            ->where('resultado_informe.id_informe_items','=',$request->id_informe)
            ->get();
        ...
        foreach ($consulta as $items){
            ...
            $tabla = [
                ...
                'titulo' => $items->titulo,
                'estamento' => '<a class="btn btn-sm btn-primary me-2 botonAgregar">Agregar<span class="fa fa-plus"></span></a>',
